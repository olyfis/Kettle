...
$(function() {
  ...
  function openWin() {
   ...
   var myID = null;
   myID = document.getElementById('appID').value;
 ...
 <xsl:sort select="CO_custName"/>
    ...
    <tr bgcolor="{$altColor}"   >
		...
		<form enctype="multipart/form-data" method="post" >
		 <input type="text" id="appID"     value="{APP_CONTRACT_NUMBER}"       /> 
		<input id="b_app" type="button" value="Asset Info" onclick="openWin('appID')"/> 				  
	      
	   
	<!--
		<input type="hidden" name="appID"> 
			<xsl:attribute name="value">
			<xsl:value-of select="APP_CONTRACT_NUMBER"/>
		 </xsl:attribute>
		</input>
	 -->
